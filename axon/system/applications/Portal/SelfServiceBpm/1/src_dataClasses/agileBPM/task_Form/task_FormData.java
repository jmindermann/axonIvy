...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = 4246191454498907875L;
  ...
  private ch.ivyteam.ivy.security.IUser selectedActor;

  /**
   * Gets the field selectedActor.
   * @return the value of the field selectedActor; may be null.
   */
  public ch.ivyteam.ivy.security.IUser getSelectedActor()
  {
    return selectedActor;
  }

  /**
   * Sets the field selectedActor.
   * @param _selectedActor the new value of the field selectedActor.
   */
  public void setSelectedActor(ch.ivyteam.ivy.security.IUser _selectedActor)
  {
