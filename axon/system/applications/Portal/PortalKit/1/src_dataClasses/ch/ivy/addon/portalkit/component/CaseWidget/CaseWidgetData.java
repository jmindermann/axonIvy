...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -1359454823729126886L;
  ...
  private java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> publicFilters;

  /**
   * Gets the field publicFilters.
   * @return the value of the field publicFilters; may be null.
   */
  public java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> getPublicFilters()
  {
   ...
   */
  public void setPublicFilters(java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> _publicFilters)
  {
    publicFilters = _publicFilters;
  }

  private java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> privateFilters;

  /**
   * Gets the field privateFilters.
   * @return the value of the field privateFilters; may be null.
   */
  public java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> getPrivateFilters()
  {
   ...
   */
  public void setPrivateFilters(java.util.List<ch.ivy.addon.portalkit.casefilter.CaseFilterData> _privateFilters)
  {
    privateFilters = _privateFilters;
  }

  private ch.ivy.addon.portalkit.casefilter.CaseFilterData filterDataToBeDeleted;

  /**
   * Gets the field filterDataToBeDeleted.
   * @return the value of the field filterDataToBeDeleted; may be null.
   */
  public ch.ivy.addon.portalkit.casefilter.CaseFilterData getFilterDataToBeDeleted()
  {
   ...
   */
  public void setFilterDataToBeDeleted(ch.ivy.addon.portalkit.casefilter.CaseFilterData _filterDataToBeDeleted)
  {
