...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -6748765206735533451L;
  ...
  /**
   * Gets the field clientId.
   * @return the value of the field clientId; may be null.
   */
  ...
  /**
   * Sets the field clientId.
   * @param _clientId the new value of the field clientId.
   */
