...
@javax.annotation.Generated(comments="This is the java file of the ivy data class CaseServiceIntegratorData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class CaseServiceIntegratorData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = 8502504814194740445L;
  ...
  private transient ch.ivyteam.ivy.scripting.objects.List<ch.ivy.ws.addon.IvyCase> cases;
  ...
  private transient ch.ivy.ws.addon.ElapsedTimeStatistic elapsedTimeStatistic;

  /**
   * Gets the field elapsedTimeStatistic.
   * @return the value of the field elapsedTimeStatistic; may be null.
   */
  public ch.ivy.ws.addon.ElapsedTimeStatistic getElapsedTimeStatistic()
  {
   ...
   */
  public void setElapsedTimeStatistic(ch.ivy.ws.addon.ElapsedTimeStatistic _elapsedTimeStatistic)
  {
