...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -2000155247701542208L;
  ...
  private java.lang.Boolean isServerCompatible;

  /**
   * Gets the field isServerCompatible.
   * @return the value of the field isServerCompatible; may be null.
   */
  public java.lang.Boolean getIsServerCompatible()
  {
    return isServerCompatible;
  }

  /**
   * Sets the field isServerCompatible.
   * @param _isServerCompatible the new value of the field isServerCompatible.
   */
  public void setIsServerCompatible(java.lang.Boolean _isServerCompatible)
  {
    isServerCompatible = _isServerCompatible;
  }

  private ch.ivy.addon.portalkit.bo.RemoteLibrary remotePortalConnector;

  /**
   * Gets the field remotePortalConnector.
   * @return the value of the field remotePortalConnector; may be null.
   */
  public ch.ivy.addon.portalkit.bo.RemoteLibrary getRemotePortalConnector()
  {
    return remotePortalConnector;
  }

  /**
   * Sets the field remotePortalConnector.
   * @param _remotePortalConnector the new value of the field remotePortalConnector.
   */
  public void setRemotePortalConnector(ch.ivy.addon.portalkit.bo.RemoteLibrary _remotePortalConnector)
  {
    remotePortalConnector = _remotePortalConnector;
  }
