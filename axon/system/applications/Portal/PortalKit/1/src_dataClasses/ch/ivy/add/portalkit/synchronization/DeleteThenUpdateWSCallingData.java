...
@javax.annotation.Generated(comments="This is the java file of the ivy data class DeleteThenUpdateWSCallingData", value={"ch.ivyteam.ivy.scripting.streamInOut.IvyScriptJavaClassBuilder"})
public class DeleteThenUpdateWSCallingData extends ch.ivyteam.ivy.scripting.objects.CompositeObject
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -7386345467905338853L;
