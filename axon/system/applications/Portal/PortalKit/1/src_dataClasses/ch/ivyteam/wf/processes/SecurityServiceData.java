...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -1008152282303600643L;
  ...
  private transient ch.ivyteam.ivy.scripting.objects.List<ch.ivy.addon.portalkit.bo.RemoteRole> roles;

  /**
   * Gets the field roles.
   * @return the value of the field roles; may be null.
   */
  public ch.ivyteam.ivy.scripting.objects.List<ch.ivy.addon.portalkit.bo.RemoteRole> getRoles()
  {
    return roles;
  }
   ...
   */
  public void setRoles(ch.ivyteam.ivy.scripting.objects.List<ch.ivy.addon.portalkit.bo.RemoteRole> _roles)
  {
    roles = _roles;
  }
  ...
  /**
   * Flag to check whether find data by apps from parameter
   */
  private transient java.lang.Boolean hasAppsParam;

  /**
   * Gets the field hasAppsParam.
   * @return the value of the field hasAppsParam; may be null.
   */
  public java.lang.Boolean getHasAppsParam()
  {
    return hasAppsParam;
  }

  /**
   * Sets the field hasAppsParam.
   * @param _hasAppsParam the new value of the field hasAppsParam.
   */
  public void setHasAppsParam(java.lang.Boolean _hasAppsParam)
  {
    hasAppsParam = _hasAppsParam;
  }
