...
{
  /** SerialVersionUID */
  private static final long serialVersionUID = -3991065009728982968L;
  ...
  private transient java.util.List<ch.ivy.ws.addon.ExpiryStatistic> expiryStatistic;

  /**
   * Gets the field expiryStatistic.
   * @return the value of the field expiryStatistic; may be null.
   */
  public java.util.List<ch.ivy.ws.addon.ExpiryStatistic> getExpiryStatistic()
  {
   ...
   */
  public void setExpiryStatistic(java.util.List<ch.ivy.ws.addon.ExpiryStatistic> _expiryStatistic)
  {
  ...
  private transient ch.ivy.addon.portalkit.bo.RemoteTask task;
