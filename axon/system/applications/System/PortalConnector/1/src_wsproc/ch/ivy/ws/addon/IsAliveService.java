...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'IsAliveService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class IsAliveService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public IsAliveResult isAlive(@javax.jws.WebParam(name="apps") java.util.List<java.lang.String> apps)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
