...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'AbsenceService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class AbsenceService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public GetAbsencesOfAllUsersResult getAbsencesOfAllUsers(@javax.jws.WebParam(name="applicationNames") java.util.List<java.lang.String> applicationNames)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public GetAbsencesResult getAbsences(@javax.jws.WebParam(name="userName") java.lang.String userName, 
             @javax.jws.WebParam(name="applicationNames") java.util.List<java.lang.String> applicationNames)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  public java.util.List<ch.ivy.ws.addon.WSException> setAbsences(@javax.jws.WebParam(name="userName") java.lang.String userName, 
             @javax.jws.WebParam(name="applicationNames") java.util.List<java.lang.String> applicationNames, 
             @javax.jws.WebParam(name="absencesToUpdate") java.util.List<ch.ivy.ws.addon.types.IvyAbsence> absencesToUpdate)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
