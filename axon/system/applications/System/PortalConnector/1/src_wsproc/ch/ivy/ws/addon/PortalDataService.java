...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'PortalDataService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class PortalDataService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public AddOrUpdateResult addOrUpdate(@javax.jws.WebParam(name="customPropertyPairs") java.util.List<ch.ivy.ws.portaldata.model.CustomPropertyPair> customPropertyPairs)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public DeleteResult delete(@javax.jws.WebParam(name="propertyKeyToBeDeleted") java.lang.String propertyKeyToBeDeleted)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public DeleteByPrefixResult deleteByPrefix(@javax.jws.WebParam(name="keyPrefixToBeDeleted") java.lang.String keyPrefixToBeDeleted)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public DeleteManyPropertiesResult deleteManyProperties(@javax.jws.WebParam(name="propertyKeysToBeDeleted") java.util.List<java.lang.String> propertyKeysToBeDeleted)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public DeleteByPrefixThenUpdateResult deleteByPrefixThenUpdate(@javax.jws.WebParam(name="keyPrefixToBeDeleted") java.lang.String keyPrefixToBeDeleted, 
             @javax.jws.WebParam(name="customPropertyPairs") java.util.List<ch.ivy.ws.portaldata.model.CustomPropertyPair> customPropertyPairs)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
    DeleteByPrefixThenUpdateResult result = new DeleteByPrefixThenUpdateResult();

    params.put("keyPrefixToBeDeleted", keyPrefixToBeDeleted);
    params.put("customPropertyPairs", customPropertyPairs);

    processResult = executeProcess("deleteByPrefixThenUpdate(String,List<ch.ivy.ws.portaldata.model.CustomPropertyPair>)", params);
  ...
  /**
   * Result type for the deleteByPrefixThenUpdate method
   */
  public static class DeleteByPrefixThenUpdateResult
  {
    private java.lang.String fMessage;
