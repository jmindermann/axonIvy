...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'ServerService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class ServerService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public GetExternalHostResult getExternalHost()
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
