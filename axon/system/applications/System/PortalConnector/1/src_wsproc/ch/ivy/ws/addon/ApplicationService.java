...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'ApplicationService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class ApplicationService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public GetAllApplicationsResult getAllApplications()
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public GetApplicationsByAppNamesResult getApplicationsByAppNames(@javax.jws.WebParam(name="applicationNames") java.util.List<java.lang.String> applicationNames)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
