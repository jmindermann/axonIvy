...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'UserService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class UserService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public FindUserSettingResult findUserSetting(@javax.jws.WebParam(name="user") java.lang.String user, 
  ...
  public java.util.List<ch.ivy.ws.addon.WSException> saveUserSetting(@javax.jws.WebParam(name="userSetting") ch.ivy.ws.addon.types.IvyUserSetting userSetting, 
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public GetEmailSetttingsResult getEmailSetttings(@javax.jws.WebParam(name="applications") java.util.List<java.lang.String> applications, 
             @javax.jws.WebParam(name="user") java.lang.String user)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="errors")
  public java.util.List<ch.ivy.ws.addon.WSException> setEMailSettings(@javax.jws.WebParam(name="user") java.lang.String user, 
             @javax.jws.WebParam(name="settings") java.util.List<ch.ivy.ws.addon.types.IvyEmailSetting> settings)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public GetSubstitutesResult getSubstitutes(@javax.jws.WebParam(name="applications") java.util.List<java.lang.String> applications, 
             @javax.jws.WebParam(name="user") java.lang.String user)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="errors")
  public java.util.List<ch.ivy.ws.addon.WSException> setSubstitutes(@javax.jws.WebParam(name="username") java.lang.String username, 
             @javax.jws.WebParam(name="substitutes") java.util.List<ch.ivy.ws.addon.types.IvySubstitute> substitutes)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public GetLanguagesSettingsResult getLanguagesSettings(@javax.jws.WebParam(name="serverId") java.lang.Long serverId, 
             @javax.jws.WebParam(name="applications") java.util.List<java.lang.String> applications, 
             @javax.jws.WebParam(name="user") java.lang.String user)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="errors")
  public java.util.List<ch.ivy.ws.addon.WSException> setLanguagesSettings(@javax.jws.WebParam(name="settings") java.util.List<ch.ivy.ws.addon.types.IvyLanguageSetting> settings, 
             @javax.jws.WebParam(name="user") java.lang.String user)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="errors")
  public java.util.List<ch.ivy.ws.addon.WSException> changePassword(@javax.jws.WebParam(name="apps") java.util.List<java.lang.String> apps, 
             @javax.jws.WebParam(name="username") java.lang.String username, 
             @javax.jws.WebParam(name="password") java.lang.String password)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
    ...
    processResult = executeProcess("changePassword(List<String>,String,String)", params);
