...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'SupportedLanguageService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class SupportedLanguageService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public GetSupportedLanguagesResult getSupportedLanguages(@javax.jws.WebParam(name="applicationName") java.lang.String applicationName)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
