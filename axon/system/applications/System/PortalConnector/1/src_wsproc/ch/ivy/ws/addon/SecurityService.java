...
@javax.annotation.Generated(
  comments="This class implements the WS endpoints of the process 'SecurityService'. The class can be customized by moving it to the src-folder. See Designer Guide for more information.", 
...
public class SecurityService extends ch.ivyteam.ivy.webservice.process.restricted.AbstractWebServiceProcess
{
  ...
  public FindAllUsersResult findAllUsers(@javax.jws.WebParam(name="apps") java.util.List<java.lang.String> apps)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public FindAllRolesResult findAllRoles(@javax.jws.WebParam(name="apps") java.util.List<java.lang.String> apps)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public FindUsersByRoleIdResult findUsersByRoleId(@javax.jws.WebParam(name="app") java.lang.String app, 
  ...
  @javax.jws.WebMethod
  @javax.jws.WebResult(name="result")
  public FindSecurityMembersToDelegateResult findSecurityMembersToDelegate(@javax.jws.WebParam(name="taskID") java.lang.Long taskID)
    throws ch.ivyteam.ivy.webservice.process.restricted.WebServiceProcessTechnicalException
  {
    java.util.Map<String, Object> params = new java.util.HashMap<String, Object>();
    ch.ivyteam.ivy.scripting.objects.Tuple processResult;
